                    ...
                    <aside class="app-sidebar">
                        ...
                        <div class="app-sidebar3">
                            ...
                            <ul class="side-menu custom-ul">
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        <svg class="sidemenu_icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                                            <g>
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        ...
                                        <span class="side-menu__label">{{trans('langconvert.adminmenu.projects')}}</span><i class="angle fa fa-angle-right"></i>
                                    </a>
                                    <ul class="slide-menu custom-ul">
                                        <li><a href="{{url('/admin/projects')}}" class="slide-item">{{trans('langconvert.adminmenu.projects')}}</a></li>
                                        <li><a href="{{url('/admin/subprojects')}}" class="slide-item">{{trans('langconvert.adminmenu.sub_projects')}}</a></li>
                                    </ul>
                                </li>
                                @endcan
                                ...
                                <li class="slide">
                                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                        <svg class="sidemenu_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" fill="#000000">
                                            <path d="M0 0h24v24H0V0z" fill="none" />
