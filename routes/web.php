...
Route::middleware(ProtectAgainstSpam::class)->group(function () {
	...
	Route::middleware(['checkinstallation'])->group(function () {
		...
		Route::middleware(['admincountryblock', 'throttle:refresh', 'ipblockunblock', 'apichecking'])->group(function () {
			...
			Route::group(['namespace' => 'Admin', 'prefix'	 => 'admin'], function () {
				...
				Route::middleware('auth', 'admin.auth')->group(function () {
					...
					Route::get('/subprojects', 'ProjectsController@sub_projects')->name('subprojects');
					...
					Route::post('/projects/subprojects/create', 'ProjectsController@sub_projects_store')->name('subprojects.create');
					Route::get('/projects/{id}', 'ProjectsController@show')->name('projects.view');
					Route::get('/projects/subprojects/{id}', 'ProjectsController@sub_projects_show')->name('subprojects.create');
					...
					Route::post('/subprojectssassigned', 'ProjectsController@subprojectssassigned');
					Route::get('/projects/subprojects/delete/{id}', 'ProjectsController@destroy_subprojects');
					Route::get('/subprojects/massproject/delete', 'ProjectsController@subprojectsmassdestroy');
		...
		Route::post('projectlist', [GuestticketController::class, 'projectlist'])->name('guest.projectlist');
